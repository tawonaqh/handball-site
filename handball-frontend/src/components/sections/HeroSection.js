...
export default function HeroSection() {
  ...
  return (
    <div className="relative w-full h-[600px] sm:h-[700px] md:h-[800px] overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pt-20 pb-12 sm:pt-28 sm:pb-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500/20 to-yellow-500/20 backdrop-blur-md border border-orange-400/30 text-orange-200 px-4 py-2 sm:px-6 sm:py-3 rounded-full shadow-2xl mb-6 sm:mb-8"
            >
              <motion.div
              ...
              <span className="font-bold text-sm sm:text-lg">Zimbabwe's Premier Handball Hub</span>
            </motion.div>
            
            {/* Main Heading */}
            <motion.h1 
              className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-4 sm:mb-6"
            ...
            {/* Description */}
            <motion.p 
              className="text-base sm:text-xl md:text-2xl font-light text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12 px-2"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: isLoaded ? 1 : 0, y: isLoaded ? 0 : 20 }}
              transition={{ delay: 0.7, duration: 0.8 }}
            >
              Live tournaments, rankings, player stats and breaking news from across Zimbabwe.
            </motion.p>
            ...
            >
              <Link
                href="/leagues"
                className="group relative bg-gradient-to-r from-orange-500 to-yellow-500 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-2xl font-bold text-base sm:text-lg shadow-2xl hover:shadow-orange-500/25 transition-all duration-500 transform hover:scale-105 flex items-center space-x-3 overflow-hidden w-full sm:w-auto justify-center max-w-xs"
              >
              ...
              <Link
                href="/rankings"
                className="group glass border-2 border-white/40 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-2xl font-bold text-base sm:text-lg hover:bg-white/20 hover:border-white/60 transition-all duration-500 flex items-center space-x-3 backdrop-blur-md w-full sm:w-auto justify-center max-w-xs"
              >
            ...
            <motion.div
              ...
              className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 lg:gap-8 max-w-4xl mx-auto px-2"
            >
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-xs sm:text-sm text-gray-300 font-medium group-hover:text-white transition-colors">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
