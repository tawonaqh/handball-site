      ...
      >
        <div className="min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold text-white flex items-center space-x-3">
            <Scale className="w-7 h-7 sm:w-8 sm:h-8 text-teal-500 flex-shrink-0" />
            <span>Referees</span>
          </h1>
          <p className="text-gray-400 mt-1 sm:mt-2 text-sm sm:text-base">Manage referee registrations and certifications</p>
        </div>
        
        <Link href="/admin/referees/create" className="flex-shrink-0">
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-teal-500 to-teal-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative flex-1">
              ...
              <select
                ...
                className="w-full pl-10 pr-8 py-3 bg-gray-700/50 border border-gray-600/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all duration-300 appearance-none"
              >
